...
class OpeningScrawler{
  ...
  constructor(){
    this.#FILLERS = {
      ...
      items: ["spaceships", "speeders", "star scooters", "freighters", "guys", "big worms", "sabermen", "blastermen", "gravity wells", "detonators", "fighters", "Walkers", "firesprays", "astromechs", "droids", "assassins", "buzz droids", "interceptors", "ion drives", "warp arrays"],
